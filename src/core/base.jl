...
function ref_add_core!(refs::Dict{Symbol,<:Any})
    _ref_add_core!(refs[:nw], base_density=refs[:base_density], base_viscosity=refs[:base_viscosity], base_diameter=refs[:base_diameter], base_length=refs[:base_length], base_flow=refs[:base_flow], base_head=refs[:base_head], base_elevation=refs[:base_elevation], base_b=refs[:base_b])
end

function _ref_add_core!(nw_refs::Dict{Int,<:Any}; base_density=850, base_viscosity= 4.9e-6, base_diameter=0.75, base_length=100, base_flow = 1, base_head = 100, base_elevation = 100, base_b = 100)
