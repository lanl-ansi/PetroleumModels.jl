...
"MISOCP Model Type"
mutable struct MISOCPPetroleumModel(data::Dict{String,Any}; kwargs...)  <: AbstractMISOCPModel @pm_fields end
# MISOCPPetroleumModel(data::Dict{String,Any}; kwargs...) = GenericPetroleumModel(data, StandardMISOCPForm)
